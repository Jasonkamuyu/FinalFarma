    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Products, ProductViewHolder>adapter =new FirebaseRecyclerAdapter<Products, ProductViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull Products model) {
                ...
                holder.txtBuyerLocation.setText("Buyer Location:  "+model.getFarmerAddress());
    ...
    private void ChangeProductState(String productID) {
        ...
        unverifiedProductsRef.child(productID).child("productState").setValue("Approved")
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    {
                        Toast.makeText(AdminCheckNewProductsActivity.this, "That item Has Been Approved and Available for sale from the Farmer", Toast.LENGTH_LONG).show();

...
import com.example.finalmkulima.CountryData;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText InputName, InputEmailAddress, InputPhoneNumber, InputPassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner=findViewById(R.id.phone_number_spinner);
...
//            startActivity(intent);
    ...
    public void ValidatephoneNumber(final String name, final String email, final String phone, final String password)
    {
